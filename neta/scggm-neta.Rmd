...
print(xtable(xhubtab[1:40,], display  = c("d","s", "s", "d", "s", "s"), caption = cap),
...
xlsx::write.xlsx(x = hgp, file = file.path(netadir, "scggm-cna-neighborhood-go-modularity.xlsx"), row.names = F)
